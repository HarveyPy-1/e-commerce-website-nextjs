...
const Footer = () => {
	...
	return (
		<>
			<footer className="footer p-10 bg-yellow-100 text-base-content">
				<nav>
			...
			<footer className="footer px-10 py-4 border-t bg-yellow-200 text-base-content border-base-300">
				...
				<nav className="md:place-self-center md:justify-self-end">
					<div className="grid grid-flow-col gap-4">
						<a href="https://twitter.com/HARVEY_dwg">
							<svg
						...
						<a href="https://github.com/HarveyPy-1">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="26"
								height="26"
						...
						<a href="https://www.linkedin.com/in/harveyezihe/">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="26"
								height="26"
